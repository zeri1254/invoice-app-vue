        ...
        <form @submit="submitForm" class="invoice-content">
            ...
            <div class="invoice-work flex flex-column">
                <div class="payment flex">
                    ...
                    <div class="input flex flex-column">
                        <label for="paymentDueDate">Срок оплаты</label>
            ...
            <div class="save flex">
                ...
                <div class="right flex">
                    <button @click="saveDraft" class="dark-purple">Сохранить</button>
                    <button @click="publishInvoice" class="purple">Создать</button>
                </div>
            </div>
        </form>
    </div>
    ...
    methods: {
        ...
        async uploadInvoice() {
            if (this.invoiceItemList.length <= 0) {
                alert('Пожалуйста, убедитесь, что вы заполнили рабочие элементы!')
                return;
            }
