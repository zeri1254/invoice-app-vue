        ...
        <Loading v-show="loading" />
            ...
            <div class="bill-from flex flex-column">
                ...
                <div class="input flex flex-column">
                    <label for="billerStreetAddress">Адрес улицы</label>
            ...
            <div class="bill-to flex flex-column">
                ...
                <div class="input flex flex-column">
                    <label for="clientStreetAddress">Адрес улицы</label>
            ...
            <div class="invoice-work flex flex-column">
                <div class="payment flex">
                    ...
                    <div class="input flex flex-column">
                        <label for="paymentDueDate">Оплата счета</label>
                ...
                <div class="work-items">
                    ...
                    <table class="item-list">
                        <tr class="table-heading flex">
                            <th class="item-name">Название продукта</th>
            ...
            <div class="save flex">
                <div class="left">
                    <button type="button" @click="closeInvoice" class="red">Отмена</button>
                </div>
                <div class="right flex">
                    <button v-if="!editInvoice" type="submit" @click="saveDraft" class="dark-purple">Сохранить счет</button>
                    <button v-if="!editInvoice" type="submit" @click="publishInvoice" class="purple">Создать счет</button>
                    <button v-if="editInvoice" type="sumbit" class="purple">Обновить счет</button>
                </div>
            </div>
        </form>
    </div>
